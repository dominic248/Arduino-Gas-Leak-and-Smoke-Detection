...
String IFTTTMaker::sendTriggerEventWithData(String eventName, DynamicJsonDocument payload) {
	String response="";
  bool finishedHeaders = false;
  bool currentLineIsBlank = true;
	long now;
...
bool IFTTTMaker::triggerEvent(String eventName , String value1, String value2, String value3){
  ...
  if(value1 != ""){
    jsonBuffer["value1"] = value1;
  }
  if(value2 != ""){
    jsonBuffer["value2"] = value2;
  }
  if(value3 != ""){
    jsonBuffer["value3"] = value3;
  }

  String response = sendTriggerEventWithData(eventName, jsonBuffer);
